...
if __name__ == "__main__":
    ...
    # Baseline algorithms (commented out - only running Aerial+ with GPU support)
    ...
    for dataset in dataset_list:
        ...
        # optimization-based ARM (commented out)
        ...
        # ARM-AE from Berteloot et al. (2024) (commented out)
